...
def run_xcode_tests(scheme, in_matrix: true)
  ...
  sh "xctool #{flags} -reporter pretty -reporter junit:$CIRCLE_TEST_REPORTS/xcode/results.xml -reporter plain:$CIRCLE_ARTIFACTS/xctool.log test; exit ${PIPESTATUS[0]}"
